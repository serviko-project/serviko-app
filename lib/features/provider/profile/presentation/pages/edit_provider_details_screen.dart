...
import 'package:serviko_app/features/provider/profile/presentation/widgets/edit_provider_details_form.dart';
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Banner Image', style: AppTextStyles.h3),
                      const SizedBox(height: AppSizes.sm),

                      // Banner Image Picker Widget
                      BannerImagePicker(initialImageUrl: _bannerImageUrl),
                      const SizedBox(height: AppSizes.lg),
                      const Divider(color: AppColors.divider, thickness: 1.5),
                      const SizedBox(height: AppSizes.lg),

                      // Edit Provider Details Form
                      EditProviderDetailsForm(
                        formKey: _formKey,
